	...
	<form name="form" id="form" action="index.php" method="post">
		...
		<div class="search">
			<table border="0" cellpadding="2" cellspacing="0">
				...
				<tr>
					...
					<th>距離</th>
					<td>
						<!-- 7/20日 ユーザー情報_仕様書_NO36,NO37による修正 -->
						<?php
						for ($i = 0; $i < 4; $i++) {
						?>
				...
				<tr>
					<th>ランク</th>
					<td>
						<!-- 7/20日 ユーザー情報_仕様書_NO20,NO21による修正 -->
						<?php
						for ($i = 0; $i < 5; $i++) {
						?>
		...
		<div class="list">
			<table border="0" cellpadding="5" cellspacing="1">
				...
				$res  = mysqli_query($param["conn"], $sql);
				$i = 0;
				//<!-- 7/21日 ユーザー情報_仕様書_NO237,238による修正 -->
		...
		<table border="0" cellpadding="5" cellspacing="1">
			...
			<tr>
				...
				<td>
					...
					?>
						<br />
						<input type="radio" name="how" value="<?php print $i + 1; ?>" <?php if ($param["how"] == $i + 1) print $check; ?> /> <?php print fnHowName($i); ?>
					<?php
					}
					?>
				</td>
