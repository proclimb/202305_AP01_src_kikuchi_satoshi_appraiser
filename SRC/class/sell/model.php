...
{
    //<!-- 8/8日 売主物件_仕様書_NO85による修正 -->
    $select  = "SELECT IF( SEARCHDT > '0000-00-00', DATE_FORMAT( SEARCHDT, '%Y/%m/%d'), '' ) AS SEARCHDT,";
    $select .= "ARTICLE,ADDRESS,STATION,IF(FOOT > 0,FOOT,''),";
